...
@ffi.def_extern()
def pyMLINC_interface_run_py(xdim, ydim, zdim, u, v, t, qv, ql, qi, qr, qs, qg, dtdt, magic_number) -> int:
    try:
        # Calling out off the bridge into the python
        pyMLINC_run(xdim, ydim, zdim, u, v, t, qv, ql, qi, qr, qs, qg, dtdt, magic_number)
    except Exception as err:
        print("Error in Python:")
        print(traceback.format_exc())
        return -1
