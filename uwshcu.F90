...
! Timer variables
      ...
      print*, '*** Timing pre-processing step ***'
...
!        cnvtrmax(i) = min(300.,max(0.,maxval(cnvtr(i,:))))
      ...
      print*,'--- Pre-Processing Step Eclipsed Time : ', (t_end - t_start)/rate

      print*, '*** Timing compute_uwshcu ***'
      call system_clock(t_start,rate)
      ...
      print*,'--- compute_uwshcu Eclipsed Time : ', (t_end - t_start)/rate

      print*, '*** Timing post-processing step ***'
      call system_clock(t_start,rate)
    ...
    ! Re-scale liquid/ice water sub-tendencies to enforce conservation
      ...
      print*,'   Post-Processing Eclipsed Time : ', (t_end - t_start)/rate
