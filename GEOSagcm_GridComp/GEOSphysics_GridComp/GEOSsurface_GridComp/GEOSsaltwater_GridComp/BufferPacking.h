...
!------------------------------------------------------------------------
      ...
      LN = L1 + NUMMAX - 1
      PTR1(1:NUMMAX) => BUFIMP(L1:LN)
      FRZMLT =>  PTR1(1:NUM2DO)
      L1 = LN + 1
      call CICEReorder(BUFIMP(L1),LATS,TILE_WITH_ICE,NUMMAX,HorzDims,1,PACKIT)
      LN = L1 + NUMMAX - 1
      PTR1(1:NUMMAX) => BUFIMP(L1:LN)
      lats2do =>  PTR1(1:NUM2DO) 
      L1 = LN + 1
      call CICEReorder(BUFIMP(L1),LONS,TILE_WITH_ICE,NUMMAX,HorzDims,1,PACKIT)
      LN = L1 + NUMMAX - 1
      PTR1(1:NUMMAX) => BUFIMP(L1:LN)
      lons2do =>  PTR1(1:NUM2DO)
...
!not all exports will necessarily be needed but memory will be allocated just in case
      ...
      LN = 0
      L1 = LN + 1
      call MAPL_GetPointer(EXPORT,PTR1,'EMIS', alloc=.true., __RC__)
      LN = L1 + NUMMAX -1
      PTR1(1:NUMMAX) => BUFEXP(L1:LN)
      EMISS => PTR1(1:NUM2DO)
      L1 = LN + 1
      call MAPL_GetPointer(EXPORT,PTR1,'ALBVF', alloc=.true., __RC__)
      LN = L1 + NUMMAX -1
      PTR1(1:NUMMAX) => BUFEXP(L1:LN)
      ALBVF => PTR1(1:NUM2DO)
      L1 = LN + 1
      call MAPL_GetPointer(EXPORT,PTR1,'ALBVR', alloc=.true., __RC__)
      LN = L1 + NUMMAX -1
      PTR1(1:NUMMAX) => BUFEXP(L1:LN)
      ALBVR => PTR1(1:NUM2DO)
      L1 = LN + 1
      call MAPL_GetPointer(EXPORT,PTR1,'ALBNF', alloc=.true., __RC__)
      LN = L1 + NUMMAX -1
      PTR1(1:NUMMAX) => BUFEXP(L1:LN)
      ALBNF => PTR1(1:NUM2DO)
      L1 = LN + 1
      call MAPL_GetPointer(EXPORT,PTR1,'ALBNR', alloc=.true., __RC__)
      LN = L1 + NUMMAX -1
      PTR1(1:NUMMAX) => BUFEXP(L1:LN)
      ALBNR => PTR1(1:NUM2DO)
      L1 = LN + 1
