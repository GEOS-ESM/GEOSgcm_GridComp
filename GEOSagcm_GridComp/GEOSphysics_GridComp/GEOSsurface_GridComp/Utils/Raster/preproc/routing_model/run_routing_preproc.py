...
# Path to "bcs_shared" directory:
    ...
    file_path2  = "/discover/nobackup/projects/gmao/bcs_shared/preprocessing_bcs_inputs/route/routing_model/v1" 
    ...
    run([f"./get_num_sub_catchment.x", file_pfafmap, file_rst])  
