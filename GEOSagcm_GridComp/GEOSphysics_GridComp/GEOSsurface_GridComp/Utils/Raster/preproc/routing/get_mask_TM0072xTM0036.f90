...
call read_ncfile_double1d("outputs/TM0072xTM0036-Pfafstetter_Greenland_real.nc","lon",lon,nlon)
call read_ncfile_double1d("outputs/TM0072xTM0036-Pfafstetter_Greenland_real.nc","lat",lat,nlat)
call read_ncfile_int2d("outputs/TM0072xTM0036-Pfafstetter_Greenland_real.nc","data",mask_rst,nlon,nlat)
