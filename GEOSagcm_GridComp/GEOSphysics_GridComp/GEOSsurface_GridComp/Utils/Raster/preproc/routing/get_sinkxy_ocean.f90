...
open(77,file="outputs/outlet_sinklat_TM0072xTM0036_mask.txt")
read(77,*)lats
open(77,file="outputs/outlet_sinklon_TM0072xTM0036_mask.txt")
read(77,*)lons
...
open(88,file="outputs/outlet_sinky_TM0072xTM0036_mask.txt")
do i=1,ns
  write(88,*)lati(i)
enddo
open(88,file="outputs/outlet_sinkx_TM0072xTM0036_mask.txt")
do i=1,ns
  write(88,*)loni(i)
enddo
