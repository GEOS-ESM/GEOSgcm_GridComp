...
#PBS -o /discover/nobackup/smahanam//Ganymed-4_0_UNSTABLE/GEOSagcm/src/GEOSgcs_GridComp/GEOSgcm_GridComp/GEOSagcm_GridComp/GEOSphysics_GridComp/GEOSsurface_GridComp/Shared/Raster/src/loss_perhour.txt
#PBS -j oe
#PBS -q general_small
