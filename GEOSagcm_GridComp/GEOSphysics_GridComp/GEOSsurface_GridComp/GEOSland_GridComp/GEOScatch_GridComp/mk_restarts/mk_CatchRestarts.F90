        ...
        if (.not.InCfg%is_coordinate_variable(var_name)) then
           ...
           if (.not.written(n) ) then
              ...
              if (ndims == 1) then
                 ...
                 call MAPL_VarWrite(OutFmt,var_name,var1(id))
                 ...
                 do j=1,dim1
                    ...
                    call MAPL_VarWrite(OutFmt,var_name,var1(id),offset1=j)
                 enddo
                 ...
                 do k=1,dim2
                    do j=1,dim1
                       ...
                       call MAPL_VarWrite(OutFmt,var_name,var1(id),offset1=j,offset2=k)
                    enddo
                 enddo
