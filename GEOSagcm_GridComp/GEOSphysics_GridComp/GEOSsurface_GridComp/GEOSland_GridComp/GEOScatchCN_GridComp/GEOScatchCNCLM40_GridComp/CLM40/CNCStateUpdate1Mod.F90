...
! local pointers to implicit in/out arrays
   ...
   real, pointer :: cpool(:)              ! (gC/m2) temporary photosynthate C pool
   real, pointer :: xsmrpool(:)           ! (gC/m2) execss maint resp C pool
...
! local pointers for dynamic landcover fluxes and states
   real, pointer :: dwt_seedc_to_leaf(:)
   real, pointer :: dwt_seedc_to_deadstem(:)
   real, pointer :: dwt_frootc_to_litr1c(:)
   real, pointer :: dwt_frootc_to_litr2c(:)
   real, pointer :: dwt_frootc_to_litr3c(:)
   real, pointer :: dwt_livecrootc_to_cwdc(:)
   real, pointer :: dwt_deadcrootc_to_cwdc(:)
   real, pointer :: seedc(:)
