...
! local pointers to implicit in arrays
   ...
   real, pointer :: woody(:)       ! binary flag for woody lifeform
                                       ! (1=woody, 0=not woody)
...
! local pointers to implicit out arrays
   ...
   real, pointer :: m_leafn_to_litter(:)
   real, pointer :: m_frootn_to_litter(:)
   real, pointer :: m_livestemn_to_litter(:)
   real, pointer :: m_deadstemn_to_litter(:)
   real, pointer :: m_livecrootn_to_litter(:)
   real, pointer :: m_deadcrootn_to_litter(:)
   real, pointer :: m_retransn_to_litter(:)
   real, pointer :: m_leafn_storage_to_litter(:)
   real, pointer :: m_frootn_storage_to_litter(:)
   real, pointer :: m_livestemn_storage_to_litter(:)
   real, pointer :: m_deadstemn_storage_to_litter(:)
   real, pointer :: m_livecrootn_storage_to_litter(:)
   real, pointer :: m_deadcrootn_storage_to_litter(:)
   real, pointer :: m_leafn_xfer_to_litter(:)
   real, pointer :: m_frootn_xfer_to_litter(:)
   real, pointer :: m_livestemn_xfer_to_litter(:)
   real, pointer :: m_deadstemn_xfer_to_litter(:)
   real, pointer :: m_livecrootn_xfer_to_litter(:)
   real, pointer :: m_deadcrootn_xfer_to_litter(:)
!
! !OTHER LOCAL VARIABLES:
   integer :: p                         ! pft index
   integer :: fp                        ! pft filter index
   real:: am                        ! rate for fractional mortality (1/yr)
   real:: m                         ! rate for fractional mortality (1/s)
   real:: mort_max                  ! asymptotic max mortality rate (/yr)
   real, parameter :: k_mort = 0.3  !coeff of growth efficiency in mortality equation
!EOP
!-----------------------------------------------------------------------
...
! local pointers to implicit in/out arrays
   ...
   real, pointer :: m_leafn_to_litr1n(:)
   real, pointer :: m_leafn_to_litr2n(:)
   real, pointer :: m_leafn_to_litr3n(:)
   real, pointer :: m_frootn_to_litr1n(:)
   real, pointer :: m_frootn_to_litr2n(:)
   real, pointer :: m_frootn_to_litr3n(:)
   real, pointer :: m_livestemn_to_cwdn(:)
   real, pointer :: m_deadstemn_to_cwdn(:)
   real, pointer :: m_livecrootn_to_cwdn(:)
   real, pointer :: m_deadcrootn_to_cwdn(:)
   real, pointer :: m_retransn_to_litr1n(:)
   real, pointer :: m_leafn_storage_to_litr1n(:)
   real, pointer :: m_frootn_storage_to_litr1n(:)
   real, pointer :: m_livestemn_storage_to_litr1n(:)
   real, pointer :: m_deadstemn_storage_to_litr1n(:)
   real, pointer :: m_livecrootn_storage_to_litr1n(:)
   real, pointer :: m_deadcrootn_storage_to_litr1n(:)
   real, pointer :: m_leafn_xfer_to_litr1n(:)
   real, pointer :: m_frootn_xfer_to_litr1n(:)
   real, pointer :: m_livestemn_xfer_to_litr1n(:)
   real, pointer :: m_deadstemn_xfer_to_litr1n(:)
   real, pointer :: m_livecrootn_xfer_to_litr1n(:)
   real, pointer :: m_deadcrootn_xfer_to_litr1n(:)
!
! local pointers to implicit out arrays
!
!
