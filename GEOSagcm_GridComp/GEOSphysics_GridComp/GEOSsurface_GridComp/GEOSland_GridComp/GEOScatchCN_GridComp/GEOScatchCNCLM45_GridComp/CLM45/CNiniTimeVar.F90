...
! !USES:
   ...
   use clm_varctl  , only: use_c13, use_c14, crop_prog
...
!   call get_proc_bounds(begg, endg, begl, endl, begc, endc, begp, endp)  ! fzeng, followed what gkw did before
