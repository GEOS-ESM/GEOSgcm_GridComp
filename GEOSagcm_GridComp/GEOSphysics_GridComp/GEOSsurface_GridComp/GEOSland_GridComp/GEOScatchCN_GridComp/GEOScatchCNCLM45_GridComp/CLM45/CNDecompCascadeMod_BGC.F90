...
if ( spinup_state .eq. 1 ) then
   ...
   if ( nlevdecomp .eq. 1 ) then
      ...
      frw(lbc:ubc) = 0._r8
      nlev_soildecomp_standard=1   ! 5 originally in CLM4.5, changed to 1 because we have only 1 hydrologically active soil layer (1m thick, see CN_Driver), fzeng, 10 Mar 2017 
