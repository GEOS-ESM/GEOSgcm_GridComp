module compute_rc_functions
  ...
  contains
    ...
    subroutine pft_clm_to_pso(clm_pft,pso_pft)
      ...
      ! 4 	broadleaf evergreen tropical tree				            ! broadleaf tree
      ! 5 	broadleaf evergreen temperate tree				            ! broadleaf tree
      ! 6 	broadleaf deciduous tropical tree				            ! broadleaf tree
      ! 7 	broadleaf deciduous temperate tree				            ! broadleaf tree
      ! 8 	broadleaf deciduous boreal tree					            ! broadleaf tree
