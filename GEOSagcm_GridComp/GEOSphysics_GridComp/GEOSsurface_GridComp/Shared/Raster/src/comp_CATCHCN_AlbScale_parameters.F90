...
!$OMP ENDPARALLELDO   
    ...
    SUBROUTINE regrid_alb (NTILES, id_loc)
      ...
      STATUS = NF_OPEN('data/CATCH/CATCHCN_fPAR_Alb_stats.nc4',      NF_NOWRITE,NCOutID) ; VERIFY_(STATUS)
    ...
    SUBROUTINE preprocess_m09
      ...
      inquire(file='data/CATCH/CATCHCN_fPAR_Alb_stats.nc4', exist=file_exists)
      ...
      STATUS = NF_OPEN ('data/CATCH/CATCHCN_fPAR_Alb_stats.nc4', NF_WRITE,NCOutID) ; VERIFY_(STATUS)
    ...
    SUBROUTINE create_stat_file
      ...
      STATUS = NF_CREATE ('data/CATCH/CATCHCN_fPAR_Alb_stats.nc4',  NF_NETCDF4, NCFOutID );VERIFY_(STATUS)
    ...
    SUBROUTINE compute_stats (MODIS_VISDF, MODIS_NIRDF, MODEL_fPAR, &
      ...
      integer :: NX, NY, N, t
      REAL    :: MF, MV, MN, SF, SV, SN, CV, CN, ZV, ZN
      ...
      DO N = 1, NX
          ...
          do T = 1, NY
             SF = SF + (MODEL_fPAR  (N,t) - MF)*(MODEL_fPAR  (N,t) - MF) 
             SV = SV + (MODIS_VISDF (N,t) - MV)*(MODIS_VISDF (N,t) - MV) 
             SN = SN + (MODIS_NIRDF (N,t) - MN)*(MODIS_NIRDF (N,t) - MN) 
          end do

          SF = SQRT (SF /REAL (NY)) + 1.e-15
          SV = SQRT (SV /REAL (NY)) + 1.e-15
          SN = SQRT (SN /REAL (NY)) + 1.e-15
