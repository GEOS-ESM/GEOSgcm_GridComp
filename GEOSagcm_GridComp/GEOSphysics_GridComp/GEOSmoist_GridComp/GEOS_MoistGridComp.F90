...
!!$      real, dimension(IM,JM,LM) :: CUSNOWMOVE_X 
      ...
      real :: turnrhcrit, sigmaqt, qcn, cfn, qsatn, dqlls, dqils, qt
              ...
              do I=1,IM
                ...
                if (CLCN(i,j,k).lt.1.0) then
                  ...
                  do n = 1,10
                    ...
                    IFRC = ICE_FRACTION( TEMP(I,J,K), CNV_FRACTION(I,J), SNOMAS(I,J), FRLANDICE(I,J), FRLAND(I,J) )
