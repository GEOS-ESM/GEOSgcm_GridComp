...
subroutine GF_Initialize (MAPL, CLOCK, RC)
    ...
    if (LM .eq. 72) then
      ...
      call MAPL_GetResource(MAPL, ZERO_DIFF_ENTR            , 'ZERO_DIFF_ENTR:'        ,default= .TRUE.,    RC=STATUS );VERIFY_(STATUS)
      ...
      call MAPL_GetResource(MAPL, ZERO_DIFF_ENTR            , 'ZERO_DIFF_ENTR:'        ,default= .FALSE.,    RC=STATUS );VERIFY_(STATUS)
    ...
    IF (USE_GF2020==1) THEN
      call MAPL_GetResource(MAPL, ICUMULUS_GF(DEEP)         , 'DEEP:'                  ,default= .TRUE.,  RC=STATUS );VERIFY_(STATUS)
      call MAPL_GetResource(MAPL, ICUMULUS_GF(SHAL)         , 'SHALLOW:'               ,default= .FALSE., RC=STATUS );VERIFY_(STATUS)
      call MAPL_GetResource(MAPL, ICUMULUS_GF(MID)          , 'CONGESTUS:'             ,default= .TRUE.,  RC=STATUS );VERIFY_(STATUS)
      ...
      if (INT(ZERO_DIFF_OTHER) == 0) then
        ...
        call MAPL_GetResource(MAPL, SATUR_CALC                , 'SATUR_CALC:'            ,default= .TRUE.,     RC=STATUS );VERIFY_(STATUS)
        call MAPL_GetResource(MAPL, BC_METH                   , 'BC_METH:'               ,default= 1,     RC=STATUS );VERIFY_(STATUS)
        call MAPL_GetResource(MAPL, USE_REBCB                 , 'USE_REBCB:'             ,default= .TRUE.,     RC=STATUS );VERIFY_(STATUS)
        call MAPL_GetResource(MAPL, LAMBAU_DEEP               , 'LAMBAU_DEEP:'           ,default= 0.0,   RC=STATUS );VERIFY_(STATUS)
        call MAPL_GetResource(MAPL, MOIST_TRIGGER             , 'MOIST_TRIGGER:'         ,default= .TRUE.,     RC=STATUS );VERIFY_(STATUS)
        call MAPL_GetResource(MAPL ,FRAC_MODIS                , 'FRAC_MODIS:'            ,default= .TRUE.,     RC=STATUS );VERIFY_(STATUS)
        call MAPL_GetResource(MAPL ,EVAP_FIX                  , 'EVAP_FIX:'              ,default= .TRUE.,     RC=STATUS );VERIFY_(STATUS)
        ...
        call MAPL_GetResource(MAPL, SATUR_CALC                , 'SATUR_CALC:'            ,default= .FALSE.,     RC=STATUS );VERIFY_(STATUS)
        call MAPL_GetResource(MAPL, BC_METH                   , 'BC_METH:'               ,default= 0,     RC=STATUS );VERIFY_(STATUS)
        call MAPL_GetResource(MAPL, USE_REBCB                 , 'USE_REBCB:'             ,default= .FALSE.,     RC=STATUS );VERIFY_(STATUS)
        call MAPL_GetResource(MAPL, LAMBAU_DEEP               , 'LAMBAU_DEEP:'           ,default= 2.0,   RC=STATUS );VERIFY_(STATUS)
        call MAPL_GetResource(MAPL, MOIST_TRIGGER             , 'MOIST_TRIGGER:'         ,default= .FALSE.,     RC=STATUS );VERIFY_(STATUS)
        call MAPL_GetResource(MAPL ,FRAC_MODIS                , 'FRAC_MODIS:'            ,default= .FALSE.,     RC=STATUS );VERIFY_(STATUS)
        call MAPL_GetResource(MAPL ,EVAP_FIX                  , 'EVAP_FIX:'              ,default= .FALSE.,     RC=STATUS );VERIFY_(STATUS)
      ...
      call MAPL_GetResource(MAPL, OUTPUT_SOUND              , 'OUTPUT_SOUND:'          ,default= .FALSE.,    RC=STATUS );VERIFY_(STATUS)
      ...
      call MAPL_GetResource(MAPL, APPLY_SUB_MP              , 'APPLY_SUB_MP:'          ,default= .FALSE.,    RC=STATUS );VERIFY_(STATUS)
      call MAPL_GetResource(MAPL, ALP1                      , 'ALP1:'                  ,default= 1.,   RC=STATUS );VERIFY_(STATUS)
      call MAPL_GetResource(MAPL, LIGHTNING_DIAG            , 'LIGHTNING_DIAG:'        ,default= .FALSE.,    RC=STATUS );VERIFY_(STATUS)
      call MAPL_GetResource(MAPL, OVERSHOOT                 , 'OVERSHOOT:'             ,default= 0.,   RC=STATUS );VERIFY_(STATUS)
      call MAPL_GetResource(MAPL, USE_WETBULB               , 'USE_WETBULB:'           ,default= .FALSE.,    RC=STATUS );VERIFY_(STATUS)
      ...
      call MAPL_GetResource(MAPL, USE_LINEAR_SUBCL_MF       , 'USE_LINEAR_SUBCL_MF:'   ,default= .FALSE.,    RC=STATUS );VERIFY_(STATUS)
