...
contains
  ...
  subroutine GFDL_1M_Run (GC, IMPORT, EXPORT, CLOCK, RC)
    ...
    !!$acc parallel loop gang vector collapse(3) private(facEIS, &
    !!$acc     minrhcrit, RHCRIT, EVAPC_C, ALPHA, I, J, L)
    do L=1,LM
       do J=1,JM
          do I=1,IM
             ...
             if (turnrhcrit <= 0.0) then
                ! TODO: DO WE NEED THE CHECK LOOP HERE??
             ...
             if (CCW_EVAP_EFF > 0.0) then ! else evap done inside GFDL
                RHCRIT = 1.0
                EVAPC(I,J,L) = Q(I,J,L)
                ! TODO: DO WE STILL NEED TO PASS Q-EVAPC DIRECTLY TO EVAP3
                call EVAP3 (         &
                     DT_MOIST      , &
                     CCW_EVAP_EFF  , &
                     RHCRIT        , &
             ...
             if (CCI_EVAP_EFF > 0.0) then ! else subl done inside GFDL
                RHCRIT = 1.0 - ALPHA
                SUBLC(I,J,L) = Q(I,J,L)
                ! TODO: DO WE NEED TO PASS Q-SUBLC DIRECTLY TO SUBL3?
                call SUBL3 (        &
                     DT_MOIST      , &
                     CCI_EVAP_EFF  , &
                     RHCRIT        , &
    ...
    do L = 1, LM
       do J = 1, JM
          do I = 1, IM
             ...
             call RADCOUPLE ( &
                  T(I,J,L), PLmb(I,J,L), CLLS(I,J,L), CLCN(I,J,L), &
                  Q(I,J,L), QLLS(I,J,L), QILS(I,J,L), QLCN(I,J,L), QICN(I,J,L), QRAIN(I,J,L), QSNOW(I,J,L), QGRAUPEL(I,J,L), &
                  NACTL(I,J,L), NACTI(I,J,L), &
