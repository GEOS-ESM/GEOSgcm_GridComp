...
module GEOS_MGB2_2M_InterfaceMod
  ...
  real  :: AUTO_CNV, LCCIRRUS, UISCALE, SS_SCALE, REEVAP_MICRO, LIU_MU, TFRZ, &
...
!#ifdef NODISABLE
    ...
    call WRITE_PARALLEL ("INITIALIZED MG in non-generic GC INIT")
      ...
      call MAPL_GetResource(MAPL, CLDPARAMS%RAIN_REVAP_FAC, 'RAIN_REVAP_FAC:', DEFAULT= 1.0 ,RC=STATUS)
      ...
      call MAPL_GetResource( MAPL, CLDPARAMS%MIN_ALLOW_CCW,  'MIN_ALLOW_CCW:',  DEFAULT= 1.0e-9  )
        ...
        call MAPL_GetResource( MAPL, CLDPARAMS%AUTOC_LS,       'AUTOC_LS:',       DEFAULT= 1.5e-3  )
        call MAPL_GetResource( MAPL, CLDPARAMS%AUTOC_ANV,      'AUTOC_ANV:',      DEFAULT= 1.5e-3  )
      ...
      call MAPL_GetResource( MAPL, CLDPARAMS%NCCN_WARM,      'NCCN_WARM:',      DEFAULT= 50.     )
      call MAPL_GetResource( MAPL, CLDPARAMS%NCCN_ICE,       'NCCN_ICE:',       DEFAULT= 0.01    )
      call MAPL_GetResource( MAPL, CLDPARAMS%NCCN_ANVIL,     'NCCN_ANVIL:',     DEFAULT= 0.1     )
      call MAPL_GetResource( MAPL, CLDPARAMS%NCCN_PBL,       'NCCN_PBL:',       DEFAULT= 200.    )
      ...
      call MAPL_GetResource( MAPL, CLDPARAMS%TANHRHCRIT,     'TANHRHCRIT:',     DEFAULT= 1.0     )
        ...
        call MAPL_GetResource( MAPL, CLDPARAMS%ANV_ICEFALL,    'ANV_ICEFALL:',    DEFAULT= 1.0     )
        call MAPL_GetResource( MAPL, CLDPARAMS%LS_ICEFALL,     'LS_ICEFALL:',     DEFAULT= 1.0     )
        call MAPL_GetResource( MAPL, CLDPARAMS%WRHODEP,        'WRHODEP:',        DEFAULT= 0.5     )
        call MAPL_GetResource( MAPL, CLDPARAMS%ICE_SETTLE,     'ICE_SETTLE:',     DEFAULT= 1.      )
        call MAPL_GetResource( MAPL, CLDPARAMS%ANV_ICEFALL,    'ANV_ICEFALL:',    DEFAULT= 0.2     )
        call MAPL_GetResource( MAPL, CLDPARAMS%LS_ICEFALL,     'LS_ICEFALL:',     DEFAULT= 0.2     )
        call MAPL_GetResource( MAPL, CLDPARAMS%WRHODEP,        'WRHODEP:',        DEFAULT= 0.0     )
         ...
         call MAPL_GetResource( MAPL, CLDPARAMS%PRECIPRAD,      'PRECIPRAD:',      DEFAULT= 1.0     )
         call MAPL_GetResource( MAPL, CLDPARAMS%SNOW_REVAP_FAC, 'SNOW_REVAP_FAC:', DEFAULT= 0.5     )
         call MAPL_GetResource( MAPL, CLDPARAMS%TURNRHCRIT,     'TURNRHCRIT:',     DEFAULT= 884.0   )
         call MAPL_GetResource( MAPL, CLDPARAMS%FAC_RI,         'FAC_RI:',         DEFAULT= 0.5     )
         call MAPL_GetResource( MAPL, CLDPARAMS%MIN_RI,         'MIN_RI:',         DEFAULT= 15.e-6  )
         call MAPL_GetResource( MAPL, CLDPARAMS%MAX_RI,         'MAX_RI:',         DEFAULT= 150.e-6 )
         call MAPL_GetResource( MAPL, CLDPARAMS%FAC_RL,         'FAC_RL:',         DEFAULT= 1.0     )
         call MAPL_GetResource( MAPL, CLDPARAMS%MIN_RL,         'MIN_RL:',         DEFAULT= 5.e-6   )
         ...
         call MAPL_GetResource( MAPL, CLDPARAMS%SNOW_REVAP_FAC, 'SNOW_REVAP_FAC:', DEFAULT= 1.0     ) ! irrelevant
         call MAPL_GetResource( MAPL, CLDPARAMS%TURNRHCRIT,     'TURNRHCRIT:',     DEFAULT= 884.0   ) ! irrelevant
         call MAPL_GetResource( MAPL, CLDPARAMS%FAC_RI,         'FAC_RI:',         DEFAULT= 1.0     )
         call MAPL_GetResource( MAPL, CLDPARAMS%MIN_RI,         'MIN_RI:',         DEFAULT= 15.e-6  )
         call MAPL_GetResource( MAPL, CLDPARAMS%MAX_RI,         'MAX_RI:',         DEFAULT= 150.e-6 )
         call MAPL_GetResource( MAPL, CLDPARAMS%FAC_RL,         'FAC_RL:',         DEFAULT= 1.0     )
         ...
         call MAPL_GetResource( MAPL, CLDPARAMS%TURNRHCRIT,     'TURNRHCRIT:',     DEFAULT= 750.0   )
     call MAPL_GetResource( MAPL, CLDPARAMS%SCLM_SHW,       'SCLM_SHW:',       DEFAULT= 1.0   )
      ...
      call MAPL_GetResource(MAPL, CLDPARAMS%MIN_LTS,'LTS_LOW:',      DEFAULT= 20.0,   __RC__) !lower LTS for morphology correction
      ...
      !call MAPL_GetResource (MAPL, JASON_TUNING, trim(COMP_NAME)//"_JASON_TUNING:", default=0, __RC__)
...
subroutine MGB2_2M_Run (GC, IMPORT, EXPORT, CLOCK, RC)
    ...
    real, pointer, dimension(:,:,:) :: CNV_DQCDT
    real, pointer, dimension(:,:,:) :: DQVDT_macro, DQIDT_macro, DQLDT_macro, &
                                       DQADT_macro, DQRDT_macro, DQSDT_macro, &
                                       DTDT_macro, SC_ICE, CLDREFFR, CLDREFFS, & 
                                       CLDREFFG, CLDREFFL, CLDREFFI, RAD_CF  , &
                                       RAD_QL, RAD_QI, RAD_QR, RAD_QS, RAD_QV, &
                                       CDNC_NUC, INC_NUC, PFRZ
    real, pointer, dimension(:,:,:) ::  &
       CNV_FICE, CNV_NDROP, CNV_NICE, CFICE, CFLIQ, DQVDT_micro, DQIDT_micro,  & 
       DQLDT_micro, DTDT_micro, DT_RASP, SMAXL, SMAXI, WSUB, CCN01, CCN04, CCN1, &
       NHET_NUC, NLIM_NUC, SO4, ORG, BCARBON, DUST, SEASALT, NCPL_VOL, NCPI_VOL, &
       SAT_RAT, QSTOT, QRTOT, QGTOT, RHICE, RL_MASK, RI_MASK, &
       ...
       PFLCNMOVE, PFICNMOVE, CNV_UPDF, CNV_CVW, DNHET_IMM, CNV_MFD, &
       CNV_PRC3, SHLW_PRC3, SHLW_SNO3, QLDET_SC, QIDET_SC, MFD_SC
    real, pointer, dimension(:,:,:) :: SC_NDROP, SC_NICE, & 
       RAD_QG, RHCmicro, RHLIQ, DPDTMST, PFI_CN, PFL_CN, PFI_LS, PFL_LS, &
       PFI_LSAN, PFL_LSAN
    real, pointer, dimension(:,:)   :: EIS, LTS, TVQ0, TVQX1, TVQX2, QCVAR_EXP, &
       CCNCOLUMN, NDCOLUMN, NCCOLUMN, CU2DRAINMOVE, CU2DSNOWMOVE

    integer, allocatable, dimension(:, :)   :: KCT, KMIN_TROP, KLCL, KPBL, KCBL
    real, allocatable, dimension(:, :)   :: TMP2D, NPRE_FRAC_2d
    real, allocatable, dimension(:,:,:) :: CNV_PLE, PLO, TH1, Q1, U1, V1, TEMP, PK
    real, allocatable, dimension(:,:,:) :: QSNOW_CN, QRAIN_CN, DP, MASS, DQS, QSS
    real                                ::  T_ICE_ALL , T_ICE_MAX
  ...
  real, allocatable, dimension(:,:,:) :: UFRC_SC, DQST3, QST3, DZET, QDDF3, FQAI, &
                     FQAL, FQA, ZLO, GZLO, DQSDT, ZLE0, ZL0

  real, allocatable, dimension(:,:)       :: CN_ARFX, AN_ARFX, LS_ARFX
  real, allocatable, dimension(:,:)       :: LS_SNR, CN_SNR, AN_SNR, SC_SNR, ZCBLx, FILLQ, MXDIAMx
  real, allocatable, dimension(:,:)       :: LS_PRC2,CN_PRC2,AN_PRC2,SC_PRC2,ER_PRC2, TPREC, TVQX

  ! Manage diagnostic outputs for re-evaporation
  !---------------------------------------------------
  real, allocatable, dimension(:,:,:) :: RSU_CN_X, RSU_AN_X, RSU_LS_X, RSU_SC_X, RSU_MC_X, REV_CN_X, REV_AN_X, REV_LS_X, REV_SC_X, REV_MC_X

  ! Manage diagnostic outputs for accretion
  !---------------------------------------------------
  real, allocatable, dimension(:,:,:) :: ACIL_CN_X, ACIL_AN_X, ACIL_LS_X, ACIL_SC_X, ACLL_CN_X, ACLL_AN_X, ACLL_LS_X, ACLL_SC_X

  ! Manage diagnostic outputs for 3D precip fluxes
  !---------------------------------------------------
  real, allocatable, dimension(:,:,:) :: PFI_CN_X, PFI_AN_X, PFI_LS_X, PFI_SC_X, & 
       PFL_CN_X, PFL_AN_X, PFL_LS_X, PFL_SC_X, DLPDF_X, DIPDF_X, DLFIX_X, DIFIX_X, &
       RHX_X, AUT_X, EVAPC_X, SDM_X, SUBLC_X, FRZ_TT_X, FRZ_PP_X, DCNVL_X, DCNVI_X, &
       DNDCNV_X, DNCCNV_X

  real, allocatable, dimension(:,:,:) :: LWC_X, IWC_X, CIRRUS_FREQ_HOM_X, CIRRUS_FREQ_HET_X
  real, allocatable, dimension(:,:) ::  CLDREFFI_TOP_X, CLDREFFL_TOP_X,  NCPL_TOP_X, NCPI_TOP_X, NCPL_CLDBASEX


  real, allocatable, dimension(:,:,:) :: ALPHT_X, ALPH1_X, ALPH2_X, CFPDF_X, RHCLR_X, DQRL_X

  real, allocatable, dimension(:,:,:) :: TH

  real, allocatable, dimension(:,:,:) :: VFALLRN_CN_X, VFALLSN_CN_X
    ...
    real(ESMF_KIND_R8), allocatable, dimension(:,:) ::so4x, seasaltx, dustx, &
      ...
      real, allocatable, dimension(:,:)       :: CNVPRCP
...
! 1D
    ...
    allocate(CN_ARFX(IM,JM), __STAT__)
    allocate(AN_ARFX(IM,JM), __STAT__)
    allocate(LS_ARFX(IM,JM), __STAT__)
    allocate(KMIN_TROP(IM,JM), __STAT__)
    allocate(KLCL(IM,JM), __STAT__)
    allocate(KPBL(IM,JM), __STAT__)
    allocate(KCBL(IM,JM), __STAT__)
    allocate(TMP2D(IM,JM), __STAT__)
    ...
    allocate(UFRC_SC(IM,JM,LM ), __STAT__)
    ...
    allocate(QSNOW_CN(IM,JM,LM ), __STAT__)
    allocate(QRAIN_CN(IM,JM,LM ), __STAT__)
    ...
    allocate(CNV_NDROP_X(IM,JM,LM ), __STAT__)
    allocate(CNV_NICE_X(IM,JM,LM ), __STAT__)
    allocate(CNV_MFD_X(IM,JM,LM ), __STAT__)
    allocate(CNV_DQLDT_X(IM,JM,LM ), __STAT__)
    allocate(CNV_PRC3_X (IM,JM,LM ), __STAT__)
    allocate(CNV_UPDF_X(IM,JM,LM ), __STAT__)
    allocate(LS_SNR(IM,JM ), __STAT__)
    allocate(CN_SNR(IM,JM ), __STAT__)
    allocate(AN_SNR(IM,JM ), __STAT__)
    allocate(SC_SNR(IM,JM ), __STAT__)
    allocate(ZCBLx(IM,JM ), __STAT__)
    allocate(FILLQ(IM,JM ), __STAT__)
    allocate(MXDIAMx(IM,JM ), __STAT__)
    allocate(LS_PRC2(IM,JM ), __STAT__)
    allocate(CN_PRC2(IM,JM ), __STAT__)
    allocate(AN_PRC2(IM,JM ), __STAT__)
    allocate(SC_PRC2(IM,JM ), __STAT__)
    allocate(ER_PRC2(IM,JM ), __STAT__)
    allocate(TPREC(IM,JM ), __STAT__)
    allocate(TVQX(IM,JM ), __STAT__)
    allocate(RSU_CN_X(IM,JM,LM ), __STAT__)
    allocate(RSU_AN_X(IM,JM,LM ), __STAT__)
    allocate(RSU_LS_X(IM,JM,LM ), __STAT__)
    allocate(RSU_SC_X(IM,JM,LM ), __STAT__)
    allocate(RSU_MC_X(IM,JM,LM ), __STAT__)
    allocate(REV_CN_X(IM,JM,LM ), __STAT__)
    allocate(REV_AN_X(IM,JM,LM ), __STAT__)
    allocate(REV_LS_X(IM,JM,LM ), __STAT__)
    allocate(REV_SC_X(IM,JM,LM ), __STAT__)
    allocate(REV_MC_X(IM,JM,LM ), __STAT__)
    allocate(ACIL_CN_X(IM,JM,LM ), __STAT__)
    allocate(ACIL_AN_X(IM,JM,LM ), __STAT__)
    allocate(ACIL_LS_X(IM,JM,LM ), __STAT__)
    allocate(ACIL_SC_X(IM,JM,LM ), __STAT__)
    allocate(ACLL_CN_X(IM,JM,LM ), __STAT__)
    allocate(ACLL_AN_X(IM,JM,LM ), __STAT__)
    allocate(ACLL_LS_X(IM,JM,LM ), __STAT__)
    allocate(ACLL_SC_X(IM,JM,LM ), __STAT__)
    allocate(PFI_CN_X(IM,JM,0:LM ), __STAT__)
    allocate(PFI_AN_X(IM,JM,0:LM ), __STAT__)
    allocate(PFI_LS_X(IM,JM,0:LM ), __STAT__)
    allocate(PFI_SC_X(IM,JM,0:LM ), __STAT__)
    allocate(PFL_CN_X(IM,JM,0:LM ), __STAT__)
    allocate(PFL_AN_X(IM,JM,0:LM ), __STAT__)
    allocate(PFL_LS_X(IM,JM,0:LM ), __STAT__)
    allocate(PFL_SC_X(IM,JM,0:LM ), __STAT__)
    ...
    allocate(RHX_X(IM,JM,LM ), __STAT__)
    allocate(AUT_X(IM,JM,LM ), __STAT__)
    allocate(EVAPC_X(IM,JM,LM ), __STAT__)
    allocate(SDM_X(IM,JM,LM ), __STAT__)
    allocate(SUBLC_X(IM,JM,LM ), __STAT__)
    ...
    allocate(DNDCNV_X(IM,JM,LM ), __STAT__)
    allocate(DNCCNV_X(IM,JM,LM ), __STAT__)
    allocate(LWC_X(IM,JM,LM ), __STAT__)
    allocate(IWC_X(IM,JM,LM ), __STAT__)
    allocate(CIRRUS_FREQ_HOM_X(IM,JM,LM ), __STAT__)
    allocate(CIRRUS_FREQ_HET_X(IM,JM,LM ), __STAT__)
    ...
    allocate(ALPH1_X(IM,JM,LM ), __STAT__)
    allocate(ALPH2_X(IM,JM,LM ), __STAT__)
    allocate(CFPDF_X(IM,JM,LM ), __STAT__)
    allocate(RHCLR_X(IM,JM,LM ), __STAT__)
    allocate(DQRL_X(IM,JM,LM ), __STAT__)
    allocate(VFALLRN_CN_X(IM,JM,LM ), __STAT__)
    allocate(VFALLSN_CN_X(IM,JM,LM ), __STAT__)
    allocate(CNVPRCP(IM,JM ), __STAT__)
...
!#ifdef NODISABLE
    ...
    call MAPL_GetPointer(EXPORT, PFI_LS,   'PFI_LS'   ,  ALLOC=.TRUE., __RC__)
    call MAPL_GetPointer(EXPORT, PFI_LSAN,   'PFI_LSAN'   ,  ALLOC=.TRUE., __RC__)
    call MAPL_GetPointer(EXPORT, PFL_LS,   'PFL_LS'   ,  ALLOC=.TRUE., __RC__)
    call MAPL_GetPointer(EXPORT, PFL_LSAN,   'PFL_LSAN'   ,  ALLOC=.TRUE., __RC__)
    call MAPL_GetPointer(EXPORT, PFL_CN,   'PFL_CN'   ,  ALLOC=.TRUE., __RC__)
    call MAPL_GetPointer(EXPORT, PFI_CN,   'PFI_CN'   ,  ALLOC=.TRUE., __RC__)
    ...
    call MAPL_GetPointer(EXPORT, DPDTMST,   'DPDTMST'   ,  ALLOC=.TRUE., __RC__)
    ...
    call MAPL_GetPointer(EXPORT,  DTDT_macro, 'DTDT_macro'  , ALLOC=.TRUE., __RC__)
    call MAPL_GetPointer(EXPORT, DQVDT_macro, 'DQVDT_macro' , ALLOC=.TRUE., __RC__)
    call MAPL_GetPointer(EXPORT, DQLDT_macro, 'DQLDT_macro' , ALLOC=.TRUE., __RC__)
    call MAPL_GetPointer(EXPORT, DQIDT_macro, 'DQIDT_macro' , ALLOC=.TRUE., __RC__)
    call MAPL_GetPointer(EXPORT, DQADT_macro, 'DQADT_macro' , ALLOC=.TRUE., __RC__)
    call MAPL_GetPointer(EXPORT, DQRDT_macro, 'DQRDT_macro' , ALLOC=.TRUE., __RC__)
    call MAPL_GetPointer(EXPORT, DQSDT_macro, 'DQSDT_macro' , ALLOC=.TRUE., __RC__)
    ...
    call MAPL_GetPointer(EXPORT, QSTOT,       'QSTOT'       , ALLOC=.TRUE., __RC__)
    call MAPL_GetPointer(EXPORT, QRTOT,       'QRTOT'       , ALLOC=.TRUE., __RC__)
    call MAPL_GetPointer(EXPORT, QGTOT,       'QGTOT'       , ALLOC=.TRUE., __RC__)
    ...
    call MAPL_GetPointer(EXPORT, CU2DRAINMOVE,'CU2DRAINMOVE', ALLOC=.TRUE., __RC__)
    call MAPL_GetPointer(EXPORT, CU2DSNOWMOVE,'CU2DSNOWMOVE', ALLOC=.TRUE., __RC__)
    call MAPL_GetPointer(EXPORT, PFLCNMOVE,   'PFLCNMOVE'   , ALLOC=.TRUE., __RC__)
    call MAPL_GetPointer(EXPORT, PFICNMOVE,   'PFICNMOVE'   , ALLOC=.TRUE., __RC__)
    ...
    !call MAPL_GetPointer(EXPORT, CNV_DQLDT, 'CNV_DQLDT'     , ALLOC=.TRUE., __RC__)
    call MAPL_GetPointer(EXPORT, CNV_PRC3,   'CNV_PRC3'     , ALLOC=.TRUE., __RC__)
    call MAPL_GetPointer(EXPORT, TVQX1,   'TVQX1'     , ALLOC=.TRUE., __RC__)
    call MAPL_GetPointer(EXPORT, TVQX2,   'TVQX2'     , ALLOC=.TRUE., __RC__)
    ...
    call MAPL_GetPointer(EXPORT, TVQ0,   'TVQ0'     , ALLOC=.TRUE., __RC__)
    ...
    END DO
      ...
      do J=1,JM
       ...
       call    FIND_EIS(TH1, QSS, TEMP, ZLE, PLO, KLCL, IM, JM, LM, LTS, EIS)
         ...
         !-----------------------------------------
         call FILLQ2ZERO2( Q1, MASS, TMP2D)  
...
!                        call zeit_co("MOIST::aero_unpack")
    ...
    ! if(associated(TVQX1))  TVQX1     = SUM( (  Q1 +  QLLS + QLCN + QILS + QICN + CNV_PRC3)*DM + CNV_DQCDT*DT_MOIST , 3 )
    
         
              CNV_MFD_X      =  CNV_MFD     ! needed for cloud fraction
              CNV_DQLDT_X    =  CNV_DQCDT
              CNV_PRC3_X     = CNV_PRC3
              CNV_UPDF_X     = CNV_UPDF 
      ...
      if(associated(TVQX2)) TVQX2    = SUM( ( Q1 +  QLLS + QLCN + QILS + QICN +  QRAIN +  QSNOW + QGRAUPEL)*MASS , 3 )  + TPREC*DT_MOIST -TVQ0
        ...
        call fix_up_clouds_2M( &
         ...
         ! need to clean up small negative values. MG does can't handle them
          call FILLQ2ZERO2( Q1, MASS, TMP2D) 
          call FILLQ2ZERO2( QGRAUPEL, MASS, TMP2D) 
          call FILLQ2ZERO2( QRAIN, MASS, TMP2D) 
          call FILLQ2ZERO2( QSNOW, MASS, TMP2D) 
          call FILLQ2ZERO2( QLLS, MASS, TMP2D)
          call FILLQ2ZERO2( QLCN, MASS, TMP2D)  
          call FILLQ2ZERO2( QILS, MASS, TMP2D)
          call FILLQ2ZERO2( QICN, MASS, TMP2D)
        ...
        scale_ri =  1.0
         ...
         call MAPL_TimerOff(MAPL,"---CLDMACRO", __RC__)
...
do K= 1, LM
  ...
  call meltfrz_inst  (     &
      ...
      call MAPL_GetPointer(EXPORT, CU2DRAINMOVE,'CU2DRAINMOVE', __RC__)
      call MAPL_GetPointer(EXPORT, CU2DSNOWMOVE,'CU2DSNOWMOVE', __RC__)
      ...
      call MAPL_GetPointer(EXPORT, PFLCNMOVE,'PFLCNMOVE', __RC__)
      call MAPL_GetPointer(EXPORT, PFICNMOVE,'PFICNMOVE', __RC__)
      ...
      if(associated(PFICNMOVE)) pficnmove = pfi_cn
       ...
       pfl_cn  (:,:,k) = pfl_cn  (:,:,k) + pfl_ls(:,:,k)*cnv_fraction
       pfl_lsan(:,:,k) = pfl_lsan(:,:,k) - pfl_ls(:,:,k)*cnv_fraction
       pfl_ls  (:,:,k) = pfl_ls  (:,:,k) - pfl_ls(:,:,k)*cnv_fraction

       pfi_cn  (:,:,k) = pfi_cn  (:,:,k) + pfi_ls(:,:,k)*cnv_fraction
       pfi_lsan(:,:,k) = pfi_lsan(:,:,k) - pfi_ls(:,:,k)*cnv_fraction
       pfi_ls  (:,:,k) = pfi_ls  (:,:,k) - pfi_ls(:,:,k)*cnv_fraction
