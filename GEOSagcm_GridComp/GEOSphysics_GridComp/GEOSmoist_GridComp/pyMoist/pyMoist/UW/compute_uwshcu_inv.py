...
def compute_uwshcu_invert_before(
    ...
    with computation(PARALLEL), interval(...):
        ...
        # REVISIT THIS
        # while n < ncnst:
        #     tr0_inout[0,0,0][n]   = reshape(CNV_Tracers(m)%Q(:,:,k_inv), (/idim/))
        #     n+=1
...
def compute_uwshcu_invert_after(
    ...
    with computation(FORWARD), interval(...):
        ...
        #     REVISIT THIS
        #     while n<ncnst:
        #        tr0(i,k,m)   = MAX(mintracer,tr0_inoutvar[0,0,0][n])
        #        n+=1
...
class ComputeUwshcuInv:
    ...
    def __call__(
        ...
        self._compute_uwshcu_invert_before(
            ...
            qi0_in=qi0_in,
            th0_in=th0_in,
            tr0_inout=FloatField_NTracer["tr0_inout"],
            tke_in=tke_in,
            pifc0_in=pifc0_in,
            zifc0_in=zifc0_in,
