...
def compute_thermodynamic_variables(
    ...
    with computation(PARALLEL), interval(0, 1):
        ...
        ssthl0 = slope(thl0, thl0_above, thl0_above, pmid0, pmid0_above, pmid0_above)
        ssqt0 = slope(qt0, qt0_above, qt0_above, pmid0, pmid0_above, pmid0_above)
        ssu0 = slope(u0, u0_above, u0_above, pmid0, pmid0_above, pmid0_above)
        ssv0 = slope(v0, v0_above, v0_above, pmid0, pmid0_above, pmid0_above)
    ...
    with computation(PARALLEL), interval(1, -1):
        ...
        # Compute slopes of environmental variables in each layer
        ssthl0 = slope(thl0, thl0_above, thl0_below, pmid0, pmid0_above, pmid0_below)
        ssqt0 = slope(qt0, qt0_above, qt0_below, pmid0, pmid0_above, pmid0_below)
        ssu0 = slope(u0, u0_above, u0_below, pmid0, pmid0_above, pmid0_below)
        ssv0 = slope(v0, v0_above, v0_below, pmid0, pmid0_above, pmid0_below)
...
#             # REVISIT THIS! What shape is trsrc
#             if dotransport == 1.0:
#                 n = 0
#                 while n < ncnst:
...
#                 if id_exit == False:
#                     thvubot = thj3 * (1.0 + zvir * qvj3 - qlj3 - qij3)
#                     (
#                         thj3,
#                         qvj3,
#                         qlj3,
...
#             thj4, qvj4, qlj4, qij4, qse4, id_check4 = conden(
#                 prel, thlsrc, qtsrc, ese, esx
#             )
...
#             if id_exit == False:
#                 if THIS_K == (krel - 1):
#                     thvu[0, 0, 1] = thj4 * (1.0 + zvir * qvj4 - qlj4 - qij4)
