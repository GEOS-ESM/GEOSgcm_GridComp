    ...
    with computation(FORWARD), interval(...):
        if id_exit == False:
            ...
            if id_exit == False:
                ...
                stop35 = False
                klev = kinv
                if (klcl) >= klev and stop35 == False:
                    while klev <= (k0 - 1) and stop35 == False:
                        kbelow = klev - 1
                        if klev < (klcl):
                            thvubot = thvlsrc
                            thvutop = thvlsrc
            ...
            #                     if thvubot > thv0lcl and thvutop > thv0top.at(K=klev):
            #                         plfc, _ = getbuoy(
            #                             plcl,
            #                             thv0lcl,
            #                             pifc0.at(K=klev),
            ...
            #                             plfc,
            #                         )
            #                     elif thvubot < thv0lcl and thvutop < thv0top.at(K=klev):
            #                         _, cin = getbuoy(
            #                             plcl,
            #                             thv0lcl,
            #                             pifc0.at(K=klev),
            ...
            #                     if thvubot > thv0bot.at(
            #                         K=klev
            #                     ) and thvutop > thv0top.at(K=klev):
            #                         plfc, _ = getbuoy(
            #                             pifc0.at(K=kbelow),
            #                             thv0bot.at(K=klev),
            #                             pifc0.at(K=klev),
            ...
            #                 if thvubot > thv0bot.at(K=klev) and thvutop > thv0top.at(
            #                     K=klev
            #                 ):
            #                     plfc, _ = getbuoy(
            #                         pifc0.at(K=kbelow),
            ...
            #                         cin,
            #                     )
            #                 elif thvubot < thv0bot.at(K=klev) and thvutop < thv0top.at(
            #                     K=klev
            #                 ):
            #                     _, cin = getbuoy(
            #                         pifc0.at(K=kbelow),
