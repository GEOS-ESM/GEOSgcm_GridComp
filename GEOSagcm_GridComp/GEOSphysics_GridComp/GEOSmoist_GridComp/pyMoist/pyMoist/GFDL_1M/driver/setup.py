...
def init_temporaries(
    ...
    with computation(PARALLEL), interval(...):
        ...
        density = -dp / (constants.GRAV * dz)  # density of dry air
        p_dry = density * constants.RDGAS * unmodified_t  # dry air pressure
...
class GFDL1MDriverSetup(NDSLRuntime):
    ...
    def __call__(
        ...
        Args:
            ...
            omq (out): conversion factor for mixing ratios
        ...
        self._init_temporaries(
            ...
            unmodified_mixing_ratio_rain,
            unmodified_mixing_ratio_ice,
            unmodified_mixing_ratio_snow,
            unmodified_mixing_ratio_graupel,
            unmodified_cloud_fraction,
            dry_air_mixing_ratio_vapor,
            dry_air_mixing_ratio_liquid,
            dry_air_mixing_ratio_rain,
            dry_air_mixing_ratio_ice,
