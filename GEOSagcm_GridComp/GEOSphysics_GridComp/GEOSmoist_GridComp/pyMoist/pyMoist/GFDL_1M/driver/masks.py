...
class Masks:
    ...
    def make(cls, quantity_factory: QuantityFactory):
        ...
        melting_mask_1 = quantity_factory.zeros([X_DIM, Y_DIM, Z_DIM], "n/a", dtype=bool)
        melting_mask_2 = quantity_factory.zeros([X_DIM, Y_DIM, Z_DIM], "n/a", dtype=bool)
        current_k_level = quantity_factory.zeros([X_DIM, Y_DIM, Z_DIM], "n/a", dtype=Int)
