...
class GFDL1MDriver(NDSLRuntime):
    ...
    def __call__(
        ...
        self._setup(
            ...
            unmodified_cloud_fraction=self._locals.unmodified.cloud_fraction,
        ...
        for _ in dace.nounroll(range(self.config_dependent_constants.NTIMES)):
            self._fall_speed(
                ...
                t_unmodified=self._locals.unmodified.t,
                t=self._locals.t,
                dz_unmodified=self._locals.unmodified.dz,
                dz=self._locals.dz,
                density_unmodified=self._locals.unmodified.density,
                density=self._locals.density,
        ...
        self._finish(
            ...
            cloud_fraction_unmodified=self._locals.unmodified.cloud_fraction,
            ...
            dvdt=dvdt,
            dp_unmodified=self._locals.unmodified.dp,
