    ...
    def __init__(self, cumulus_parameterization_config: GF2020CumulusParameterizationConfig):
        if cumulus_parameterization_config.OUTPUT_SOUNDING == 1:
            raise NotImplementedError(
                "Output Sounding capabilities have not been implemented. You should have been caught"
...
class GATESounding:
    def __init__(self, cumulus_parameterization_config: GF2020CumulusParameterizationConfig):
        if cumulus_parameterization_config.WRTGRADS == 1:
            raise NotImplementedError(
                "GATE Sounding capabilities have not been implemented. You should have been caught"
                "before getting here by the config checker. Beware, something likely failing in the config"
                "checker as well - you may be unknowingly calling other untested/unimplemented sections."
            )
