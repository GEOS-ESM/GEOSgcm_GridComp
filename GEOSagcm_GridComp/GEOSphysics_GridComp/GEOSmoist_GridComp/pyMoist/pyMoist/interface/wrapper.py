...
class GEOSPyMoistWrapper:
    ...
    def init_gfdl_1m_configuration(
        ...
        CCW_EVAP_EFF = self._mapl_comp.get_resource("CCW_EVAP_EFF:", np.float32, default=1.0e-2)
        CCI_EVAP_EFF = self._mapl_comp.get_resource("CCI_EVAP_EFF:", np.float32, default=1.0e-2)
