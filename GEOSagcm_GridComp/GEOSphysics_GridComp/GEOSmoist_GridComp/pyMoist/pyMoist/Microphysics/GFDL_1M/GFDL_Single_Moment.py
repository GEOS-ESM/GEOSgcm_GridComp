...
class GFDL1M:
    def __init__(
        ...
        self.MELTFRZ = mapl_get_resource_placeholder("LMELTFRZ")
        ...
        self.phase_change = PhaseChange(
            ...
            GFDL_1M_config=self.phase_change_config,
        )
    ...
    def __call__(self, *args, **kwds):
        ...
        self.outputs.evaporation_nonanvil_large_scale_precipitation = mapl_get_pointer_placeholder("REV_LS")
        self.outputs.sublimation_nonanvil_large_scale_precipitation = mapl_get_pointer_placeholder("RSU_LS")
