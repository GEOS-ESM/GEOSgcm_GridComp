...
class TranslateBuoyancySorting(TranslateFortranData2Py):
    ...
    def compute(self, inputs):
        ...
        exnmid0 = self.quantity_factory.zeros(dims=[I_DIM, J_DIM, K_DIM], units="n/a")
        ...
        tru = self.quantity_factory.zeros(dims=[I_DIM, J_DIM, K_DIM, "ntracers"], units="n/a")
        emf = self.quantity_factory.zeros(dims=[I_DIM, J_DIM, K_DIM], units="n/a")
        thlue = self.quantity_factory.zeros(dims=[I_DIM, J_DIM, K_DIM], units="n/a")
        qtue = self.quantity_factory.zeros(dims=[I_DIM, J_DIM, K_DIM], units="n/a")
        wue = self.quantity_factory.zeros(dims=[I_DIM, J_DIM, K_DIM], units="n/a")
        wtwb = self.quantity_factory.zeros(dims=[I_DIM, J_DIM], units="n/a")
        rei = self.quantity_factory.zeros(dims=[I_DIM, J_DIM, K_DIM], units="n/a")
