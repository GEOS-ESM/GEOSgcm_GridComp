...
class TranslateGFDL_1M_WarmRain(TranslateFortranData2Py):
    ...
    def compute(self, inputs):
        ...
        safe_assign_array(
            ...
            inputs["driver_local_dp_warmrain"][:, :, :],
        )
        safe_assign_array(
            driver_locals.dz.field[:],
            inputs["driver_local_dz_warmrain"][:, :, :],
        )
        safe_assign_array(driver_locals.t.field[:], inputs["driver_local_t_warmrain"][:, :, :])
        safe_assign_array(
            driver_locals.dry_air_mixing_ratio.vapor.field[:],
            inputs["driver_local_dry_mixing_ratio_vapor_warmrain"][:, :, :],
        )
        safe_assign_array(
            driver_locals.dry_air_mixing_ratio.liquid.field[:],
            inputs["driver_local_dry_mixing_ratio_liquid_warmrain"][:, :, :],
        )
        safe_assign_array(
            driver_locals.dry_air_mixing_ratio.rain.field[:],
            inputs["driver_local_dry_mixing_ratio_rain_warmrain"][:, :, :],
        )
        safe_assign_array(
            driver_locals.dry_air_mixing_ratio.ice.field[:],
            inputs["driver_local_dry_mixing_ratio_ice_warmrain"][:, :, :],
        )
        safe_assign_array(
            driver_locals.dry_air_mixing_ratio.snow.field[:],
            inputs["driver_local_dry_mixing_ratio_snow_warmrain"][:, :, :],
        )
        safe_assign_array(
            driver_locals.dry_air_mixing_ratio.graupel.field[:],
            inputs["driver_local_dry_mixing_ratio_graupel_warmrain"][:, :, :],
        )
        safe_assign_array(
            driver_locals.cloud_fraction.field[:],
            inputs["driver_local_cloud_fraction_warmrain"][:, :, :],
        )
        safe_assign_array(
            driver_locals.ccn.field[:],
            inputs["driver_local_ccn_warmrain"][:, :, :],
        )
        safe_assign_array(
            driver_locals.density.field[:],
            inputs["driver_local_density_warmrain"][:, :, :],
        )
        safe_assign_array(
            driver_locals.density_factor.field[:],
            inputs["driver_local_density_factor_warmrain"][:, :, :],
        )
        safe_assign_array(
            driver_locals.c_praut.field[:],
            inputs["driver_local_c_praut_warmrain"][:, :, :],
        )
        safe_assign_array(
            driver_locals.terminal_speed.rain.field[:],
            inputs["driver_local_terminal_speed_rain_warmrain"][:, :, :],
        )
        safe_assign_array(
            driver_locals.evaporation.field[:],
            inputs["driver_local_evaporation_warmrain"][:, :, :],
        )
        safe_assign_array(
            driver_locals.liquid_precip_flux.field[:],
            inputs["driver_local_liquid_precip_flux_warmrain"][:, :, :],
        )
        safe_assign_array(driver_locals.w.field[:], inputs["driver_local_w_warmrain"][:, :, :])
        safe_assign_array(
            driver_locals.rh_limited.field[:],
            inputs["driver_local_rh_limited_warmrain"][:, :, :],
        )
        safe_assign_array(
        ...
        safe_assign_array(
            ...
            inputs["driver_local_mass_warmrain"][:, :, :],
        )
        safe_assign_array(
            driver_locals.ice_precip_flux.field[:],
            inputs["driver_local_ice_precip_flux_warmrain"][:, :, :],
        )
        safe_assign_array(
            driver_locals.rain.field[:],
            inputs["driver_local_rain_warmrain"][:, :, 0],
        )
        safe_assign_array(
            state.precipitation_at_surface.rain.field[:],
            inputs["surface_precip_rain_warmrain"][:, :, 0],
        )
        safe_assign_array(
            state.estimated_inversion_strength.field[:],
            inputs["estimated_inversion_strength_warmrain"][:, :, 0],
        )
        safe_assign_array(
            driver_locals.one_minus_sigma.field[:],
            inputs["driver_local_one_minus_sigma_warmrain"][:, :, 0],
        )
        ...
        safe_assign_array(
            outputs["driver_local_dp_warmrain"][:, :, :],
            driver_locals.dp.field[:],
        )
        safe_assign_array(
            outputs["driver_local_dz_warmrain"][:, :, :],
            driver_locals.dz.field[:],
        )
        safe_assign_array(outputs["driver_local_t_warmrain"][:, :, :], driver_locals.t.field[:])
        safe_assign_array(
        ...
        safe_assign_array(
            outputs["driver_local_cloud_fraction_warmrain"][:, :, :],
            driver_locals.cloud_fraction.field[:],
        )
        safe_assign_array(
            outputs["driver_local_ccn_warmrain"][:, :, :],
            driver_locals.ccn.field[:],
        )
        safe_assign_array(
            outputs["driver_local_density_warmrain"][:, :, :],
            driver_locals.density.field[:],
        )
        safe_assign_array(
            outputs["driver_local_density_factor_warmrain"][:, :, :],
            driver_locals.density_factor.field[:],
        )
        safe_assign_array(
            outputs["driver_local_c_praut_warmrain"][:, :, :],
            driver_locals.c_praut.field[:],
        )
        safe_assign_array(
        ...
        safe_assign_array(
            outputs["driver_local_evaporation_warmrain"][:, :, :],
            driver_locals.evaporation.field[:],
        )
        safe_assign_array(
        ...
        safe_assign_array(outputs["driver_local_w_warmrain"][:, :, :], driver_locals.w.field[:])
        safe_assign_array(
            outputs["driver_local_rh_limited_warmrain"][:, :, :],
            driver_locals.rh_limited.field[:],
        )
        safe_assign_array(
        ...
        safe_assign_array(
            outputs["driver_local_mass_warmrain"][:, :, :],
            driver_locals.mass.field[:],
        )
        safe_assign_array(
        ...
        for k in range(nz):
            safe_assign_array(
                outputs["driver_local_rain_warmrain"][:, :, k],
                driver_locals.rain.field[:],
            )
            safe_assign_array(
                outputs["surface_precip_rain_warmrain"][:, :, k],
                state.precipitation_at_surface.rain.field[:],
            )
            safe_assign_array(
                outputs["estimated_inversion_strength_warmrain"][:, :, k],
                state.estimated_inversion_strength.field[:],
            )
            safe_assign_array(
                outputs["driver_local_one_minus_sigma_warmrain"][:, :, k],
                driver_locals.one_minus_sigma.field[:],
            )
