...
class TranslateGFDL_1M_DriverFinish(TranslateFortranData2Py):
    ...
    def compute(self, inputs):
        ...
        driver_locals.unmodified.mixing_ratio.vapor.field[:] = inputs["driver_local_dry_mixing_ratio_vapor_unmodified_driverfinish"][:, :, :, 0]
        driver_locals.unmodified.mixing_ratio.liquid.field[:] = inputs["driver_local_dry_mixing_ratio_liquid_unmodified_driverfinish"][:, :, :, 0]
        driver_locals.unmodified.mixing_ratio.rain.field[:] = inputs["driver_local_dry_mixing_ratio_rain_unmodified_driverfinish"][:, :, :, 0]
        driver_locals.unmodified.mixing_ratio.ice.field[:] = inputs["driver_local_dry_mixing_ratio_ice_unmodified_driverfinish"][:, :, :, 0]
        driver_locals.unmodified.mixing_ratio.rain.field[:] = inputs["driver_local_dry_mixing_ratio_rain_unmodified_driverfinish"][:, :, :, 0]
        driver_locals.unmodified.mixing_ratio.graupel.field[:] = inputs["driver_local_dry_mixing_ratio_graupel_unmodified_driverfinish"][:, :, :, 0]
        state.radiation_field.cloud_fraction.field[:] = inputs["driver_local_cloud_fraciton_unmodified_driverfinish"][:, :, :, 0]
        driver_locals.dry_air_mixing_ratio.vapor.field[:] = inputs["driver_local_dry_mixing_ratio_vapor_driverfinish"][:, :, :, 0]
        driver_locals.dry_air_mixing_ratio.liquid.field[:] = inputs["driver_local_dry_mixing_ratio_liquid_driverfinish"][:, :, :, 0]
        driver_locals.dry_air_mixing_ratio.rain.field[:] = inputs["driver_local_dry_mixing_ratio_rain_driverfinish"][:, :, :, 0]
        driver_locals.dry_air_mixing_ratio.ice.field[:] = inputs["driver_local_dry_mixing_ratio_ice_driverfinish"][:, :, :, 0]
        driver_locals.dry_air_mixing_ratio.snow.field[:] = inputs["driver_local_dry_mixing_ratio_snow_driverfinish"][:, :, :, 0]
        driver_locals.dry_air_mixing_ratio.graupel.field[:] = inputs["driver_local_dry_mixing_ratio_graupel_driverfinish"][:, :, :, 0]
        locals_.driver_tendencies.dvapordt.field[:] = inputs["local_dvapordt_driver_driverfinish"][:, :, :, 0]
        locals_.driver_tendencies.dliquiddt.field[:] = inputs["local_dliquiddt_driver_driverfinish"][:, :, :, 0]
        ...
        locals_.driver_tendencies.dgraupeldt.field[:] = inputs["local_dgraupeldt_driver_driverfinish"][:, :, :, 0]
        locals_.driver_tendencies.dcloudfractiondt.field[:] = inputs["local_dcloudfractiondt_driver_driverfinish"][:, :, :, 0]
        ...
        state.precipitation_at_surface.graupel.field[:] = inputs["surface_precip_graupel_driverfinish"][:, :, 0, 0]
        ...
        outputs["driver_local_dry_mixing_ratio_vapor_unmodified_driverfinish"][:, :, :, 0] = driver_locals.unmodified.mixing_ratio.vapor.field[:]
        outputs["driver_local_dry_mixing_ratio_liquid_unmodified_driverfinish"][:, :, :, 0] = driver_locals.unmodified.mixing_ratio.liquid.field[:]
        outputs["driver_local_dry_mixing_ratio_rain_unmodified_driverfinish"][:, :, :, 0] = driver_locals.unmodified.mixing_ratio.rain.field[:]
        outputs["driver_local_dry_mixing_ratio_ice_unmodified_driverfinish"][:, :, :, 0] = driver_locals.unmodified.mixing_ratio.ice.field[:]
        outputs["driver_local_dry_mixing_ratio_rain_unmodified_driverfinish"][:, :, :, 0] = driver_locals.unmodified.mixing_ratio.rain.field[:]
        outputs["driver_local_dry_mixing_ratio_graupel_unmodified_driverfinish"][:, :, :, 0] = driver_locals.unmodified.mixing_ratio.graupel.field[:]
        outputs["driver_local_cloud_fraciton_unmodified_driverfinish"][:, :, :, 0] = state.radiation_field.cloud_fraction.field[:]
        outputs["driver_local_dry_mixing_ratio_vapor_driverfinish"][:, :, :, 0] = driver_locals.dry_air_mixing_ratio.vapor.field[:]
        outputs["driver_local_dry_mixing_ratio_liquid_driverfinish"][:, :, :, 0] = driver_locals.dry_air_mixing_ratio.liquid.field[:]
        outputs["driver_local_dry_mixing_ratio_rain_driverfinish"][:, :, :, 0] = driver_locals.dry_air_mixing_ratio.rain.field[:]
        outputs["driver_local_dry_mixing_ratio_ice_driverfinish"][:, :, :, 0] = driver_locals.dry_air_mixing_ratio.ice.field[:]
        outputs["driver_local_dry_mixing_ratio_snow_driverfinish"][:, :, :, 0] = driver_locals.dry_air_mixing_ratio.snow.field[:]
        outputs["driver_local_dry_mixing_ratio_graupel_driverfinish"][:, :, :, 0] = driver_locals.dry_air_mixing_ratio.graupel.field[:]
        outputs["local_dvapordt_driver_driverfinish"][:, :, :, 0] = locals_.driver_tendencies.dvapordt.field[:]
        outputs["local_dliquiddt_driver_driverfinish"][:, :, :, 0] = locals_.driver_tendencies.dliquiddt.field[:]
        ...
        outputs["local_dgraupeldt_driver_driverfinish"][:, :, :, 0] = locals_.driver_tendencies.dgraupeldt.field[:]
        outputs["local_dcloudfractiondt_driver_driverfinish"][:, :, :, 0] = locals_.driver_tendencies.dcloudfractiondt.field[:]
        ...
        outputs["surface_precip_graupel_driverfinish"][:, :, 0, 0] = state.precipitation_at_surface.graupel.field[:]
