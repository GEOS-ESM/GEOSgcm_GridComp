...
class TranslateGFDL_1M_DriverSetup(TranslateFortranData2Py):
    ...
    def compute(self, inputs):
        ...
        state.critical_relative_humidity_for_pdf.field[:] = inputs["critical_relative_humidity_for_pdf_driversetup"][:, :, :, 0]
        ...
        state.radiation_field.cloud_fraction.field[:] = inputs["radiation_cloud_fraction_driversetup"][:, :, :, 0]
        locals_.total_concentration.field[:] = inputs["total_concentration_driversetup"][:, :, :, 0]
        driver_locals.unmodified.mixing_ratio.vapor.field[:] = inputs["driver_local_dry_mixing_ratio_vapor_unmodified_driversetup"][:, :, :, 0]
        driver_locals.unmodified.mixing_ratio.liquid.field[:] = inputs["driver_local_dry_mixing_ratio_liquid_unmodified_driversetup"][:, :, :, 0]
        driver_locals.unmodified.mixing_ratio.rain.field[:] = inputs["driver_local_dry_mixing_ratio_rain_unmodified_driversetup"][:, :, :, 0]
        driver_locals.unmodified.mixing_ratio.ice.field[:] = inputs["driver_local_dry_mixing_ratio_ice_unmodified_driversetup"][:, :, :, 0]
        driver_locals.unmodified.mixing_ratio.snow.field[:] = inputs["driver_local_dry_mixing_ratio_snow_unmodified_driversetup"][:, :, :, 0]
        driver_locals.unmodified.mixing_ratio.graupel.field[:] = inputs["driver_local_dry_mixing_ratio_graupel_unmodified_driversetup"][:, :, :, 0]
        driver_locals.dry_air_mixing_ratio.vapor.field[:] = inputs["driver_local_dry_mixing_ratio_vapor_driversetup"][:, :, :, 0]
        driver_locals.dry_air_mixing_ratio.liquid.field[:] = inputs["driver_local_dry_mixing_ratio_liquid_driversetup"][:, :, :, 0]
        driver_locals.dry_air_mixing_ratio.rain.field[:] = inputs["driver_local_dry_mixing_ratio_rain_driversetup"][:, :, :, 0]
        driver_locals.dry_air_mixing_ratio.ice.field[:] = inputs["driver_local_dry_mixing_ratio_ice_driversetup"][:, :, :, 0]
        driver_locals.dry_air_mixing_ratio.snow.field[:] = inputs["driver_local_dry_mixing_ratio_snow_driversetup"][:, :, :, 0]
        driver_locals.dry_air_mixing_ratio.graupel.field[:] = inputs["driver_local_dry_mixing_ratio_graupel_driversetup"][:, :, :, 0]
        ...
        driver_locals.density_unmodified.field[:] = inputs["driver_local_density_unmodified_driversetup"][:, :, :, 0]
        ...
        state.non_anvil_large_scale.liquid_precip_flux.field[:, :, 0:-1] = inputs["non_anvil_large_scale_liquid_precip_flux_driversetup"][:, :, :, 0]
        state.non_anvil_large_scale.ice_precip_flux.field[:, :, 0:-1] = inputs["non_anvil_large_scale_ice_precip_flux_driversetup"][:, :, :, 0]
        state.non_anvil_large_scale.evaporation.field[:] = inputs["non_anvil_large_scale_evaporation_driversetup"][:, :, :, 0]
        state.non_anvil_large_scale.sublimation.field[:] = inputs["non_anvil_large_scale_sublimation_driversetup"][:, :, :, 0]
        driver_locals.one_minus_sigma.field[:] = inputs["driver_local_one_minus_sigma_driversetup"][:, :, 0, 0]
        ...
        state.precipitation_at_surface.graupel.field[:] = inputs["surface_precip_graupel_driversetup"][:, :, 0, 0]
        ...
        outputs["critical_relative_humidity_for_pdf_driversetup"][:, :, :, 0] = state.critical_relative_humidity_for_pdf.field[:]
        ...
        outputs["radiation_cloud_fraction_driversetup"][:, :, :, 0] = state.radiation_field.cloud_fraction.field[:]
        outputs["total_concentration_driversetup"][:, :, :, 0] = locals_.total_concentration.field[:]
        outputs["driver_local_dry_mixing_ratio_vapor_unmodified_driversetup"][:, :, :, 0] = driver_locals.unmodified.mixing_ratio.vapor.field[:]
        outputs["driver_local_dry_mixing_ratio_liquid_unmodified_driversetup"][:, :, :, 0] = driver_locals.unmodified.mixing_ratio.liquid.field[:]
        outputs["driver_local_dry_mixing_ratio_rain_unmodified_driversetup"][:, :, :, 0] = driver_locals.unmodified.mixing_ratio.rain.field[:]
        outputs["driver_local_dry_mixing_ratio_ice_unmodified_driversetup"][:, :, :, 0] = driver_locals.unmodified.mixing_ratio.ice.field[:]
        outputs["driver_local_dry_mixing_ratio_snow_unmodified_driversetup"][:, :, :, 0] = driver_locals.unmodified.mixing_ratio.snow.field[:]
        outputs["driver_local_dry_mixing_ratio_graupel_unmodified_driversetup"][:, :, :, 0] = driver_locals.unmodified.mixing_ratio.graupel.field[:]
        outputs["driver_local_dry_mixing_ratio_vapor_driversetup"][:, :, :, 0] = driver_locals.dry_air_mixing_ratio.vapor.field[:]
        outputs["driver_local_dry_mixing_ratio_liquid_driversetup"][:, :, :, 0] = driver_locals.dry_air_mixing_ratio.liquid.field[:]
        outputs["driver_local_dry_mixing_ratio_rain_driversetup"][:, :, :, 0] = driver_locals.dry_air_mixing_ratio.rain.field[:]
        outputs["driver_local_dry_mixing_ratio_ice_driversetup"][:, :, :, 0] = driver_locals.dry_air_mixing_ratio.ice.field[:]
        outputs["driver_local_dry_mixing_ratio_snow_driversetup"][:, :, :, 0] = driver_locals.dry_air_mixing_ratio.snow.field[:]
        outputs["driver_local_dry_mixing_ratio_graupel_driversetup"][:, :, :, 0] = driver_locals.dry_air_mixing_ratio.graupel.field[:]
        ...
        outputs["driver_local_density_unmodified_driversetup"][:, :, :, 0] = driver_locals.density_unmodified.field[:]
        ...
        outputs["non_anvil_large_scale_liquid_precip_flux_driversetup"][:, :, :, 0] = state.non_anvil_large_scale.liquid_precip_flux.field[:, :, 0:-1]
        outputs["non_anvil_large_scale_ice_precip_flux_driversetup"][:, :, :, 0] = state.non_anvil_large_scale.ice_precip_flux.field[:, :, 0:-1]
        outputs["non_anvil_large_scale_evaporation_driversetup"][:, :, :, 0] = state.non_anvil_large_scale.evaporation.field[:]
        outputs["non_anvil_large_scale_sublimation_driversetup"][:, :, :, 0] = state.non_anvil_large_scale.sublimation.field[:]

        for k in range(nz):
            outputs["driver_local_one_minus_sigma_driversetup"][:, :, k, 0] = driver_locals.one_minus_sigma.field[:]
            outputs["area_driversetup"][:, :, k, 0] = state.area.field[:]
            outputs["surface_precip_rain_driversetup"][:, :, k, 0] = state.precipitation_at_surface.rain.field[:]
            outputs["surface_precip_snow_driversetup"][:, :, k, 0] = state.precipitation_at_surface.snow.field[:]
            outputs["surface_precip_graupel_driversetup"][:, :, k, 0] = state.precipitation_at_surface.graupel.field[:]
