...
class TranslateRedistributeClouds(TranslateFortranData2Py):
    ...
    def compute_from_storage(self, inputs):
        ...
        return {"RAD_CF": inputs["RAD_CF"], "RAD_QL": inputs["RAD_QL"], "RAD_QI": inputs["RAD_QI"],
                "CLCN": inputs["CLCN"], "CLLS": inputs["CLLS"],
                "QLCN": inputs["QLCN"], "QLLS": inputs["QLLS"], "QICN": inputs["QICN"],
                "QILS": inputs["QILS"], "RAD_QV": inputs["RAD_QV"], "T": inputs["T"]}