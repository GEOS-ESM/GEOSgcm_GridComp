...
from pyMoist.convection.GF_2020.cumulus_parameterization.precip import output_deep_precipitation
...
class TestCore:
    ...
    def __call__(self, constants: dict, cu_param_constants: dict, plume: str, **inputs):
        ...
        state.output.error_code.data[:, :, plume_dependent_constants.PLUME_INDEX] = inputs["error_code_odp"]
        ...
        outputs = {
            "error_code_odp": state.output.error_code.field[:, :, plume_dependent_constants.PLUME_INDEX],
...
class TranslateGF2020_CumulusParameterization_OutputDeepPrecipitation_shallow(TranslateFortranData2Py):
    def __init__(
        self,
        grid: Grid,
        namelist: Namelist,
...
class TranslateGF2020_CumulusParameterization_OutputDeepPrecipitation_mid(TranslateFortranData2Py):
    def __init__(
        self,
        grid: Grid,
        namelist: Namelist,
...
class TranslateGF2020_CumulusParameterization_OutputDeepPrecipitation_deep(TranslateFortranData2Py):
    def __init__(
        self,
        grid: Grid,
        namelist: Namelist,
