...
class TranslateGF2020_CumulusParameterization_Setup_mid(TranslateFortranData2Py):
        ...
        self.out_vars.update(
            {
                ...
                "local_add_buoy_modified": {"serialname": "local_add_buoy_modified_cu_param_setup"},
    ...
    def compute_func(self, **inputs):
        ...
        state.output.ierr.data[:, :, 1] = inputs["ierr"]  # plume dependent
        ...
        outputs = {
            ...
            "ierr": state.output.ierr.field[:, :, 1],
            ...
            "local_add_buoy_modified": locals.add_buoy_modified.field[:],
