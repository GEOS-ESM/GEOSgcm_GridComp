...
class TestCore:
    ...
    def __call__(self, constants: dict, cu_param_constants: dict, plume: str, **inputs):
        ...
        locals.vapor_cloud_levels_forced.data[:] = inputs["local_vapor_cloud_levels_modified"]
        ...
        locals.gamma_cloud_levels_forced.data[:] = inputs["local_gamma_cloud_levels"]
        locals.t_cloud_levels_forced.data[:] = inputs["local_t_cloud_levels_modified"]
        ...
        outputs = {
            ...
            "local_geopotential_height_modified": state.input_output.geopotential_height_forced.field[:],
            "p_forced": state.input_output.p_forced.field[:],
            "local_env_saturation_mixing_ratio_cloud_levels_modified": locals.environment_saturation_mixing_ratio_cloud_levels_forced.field[
                :
            ],
            "local_vapor_cloud_levels_modified": locals.vapor_cloud_levels_forced.field[:],
            "local_env_moist_static_energy_cloud_levels_modified": locals.environment_moist_static_energy_cloud_levels_forced.field[
                :
            ],
            ...
            "local_env_saturation_moist_static_energy_cloud_levels_modified": locals.environment_saturation_moist_static_energy_cloud_levels_forced.field[
                :
            ],
            "local_geopotential_height_cloud_levels_modified": locals.geopotential_height_cloud_levels_forced.field[
                :
            ],
            "p_cloud_levels_forced": state.output.p_cloud_levels_forced.field[
                :, :, :, plume_dependent_constants.PLUME_INDEX
            ],
            "local_gamma_cloud_levels": locals.gamma_cloud_levels_forced.field[:],
            "local_t_cloud_levels_modified": locals.t_cloud_levels_forced.field[:],
