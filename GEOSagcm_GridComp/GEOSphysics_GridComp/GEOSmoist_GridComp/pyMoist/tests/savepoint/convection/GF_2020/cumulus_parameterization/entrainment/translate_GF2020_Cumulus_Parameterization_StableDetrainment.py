...
class TranslateGF2020_CumulusParameterization_StableDetrainment_deep(TranslateFortranData2Py):
    ...
    def compute_func(self, **inputs):
        ...
        locals.kstabm.data[:] = inputs["local_kstabm_stabledetrainment"]
        state.output.kstabi.data[:, :, plume_dependent_constants.PLUME_INDEX] = inputs[
            "kstabi_stabledetrainment"
        ]
        ...
        outputs = {
            ...
            "local_kstabm_stabledetrainment": locals.kstabm.field[:],
            "kstabi_stabledetrainment": state.output.kstabi.field[
                :, :, plume_dependent_constants.PLUME_INDEX
            ],
        }
