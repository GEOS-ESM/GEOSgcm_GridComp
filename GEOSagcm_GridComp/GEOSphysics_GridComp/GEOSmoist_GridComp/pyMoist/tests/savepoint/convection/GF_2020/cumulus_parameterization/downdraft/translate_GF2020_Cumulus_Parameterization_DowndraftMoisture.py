...
class TestCore:
    def __init__(
        ...
        in_vars["data_vars"] = {
            ...
            "local_vapor_cloud_levels_forced_downmoisture": {},
            "local_env_saturation_mixing_ratio_cloud_levels_forced_downmoisture": {},
            "local_cloud_total_water_after_entrainment_forced_downmoisture": {},
            "local_cloud_total_water_after_entrainment_downdraft_forced_downmoisture": {},
            "local_downdraft_saturation_vapor_forced_downmoisture": {},
            "local_vapor_wetbulb_downmoisture": {},
            "normalized_massflux_downdraft_forced_downmoisture": {},
            "local_env_moist_static_energy_forced_downmoisture": {},
            "local_env_saturation_moist_static_energy_cloud_levels_forced_downmoisture": {},
            "local_cloud_moist_static_energy_downdraft_forced_downmoisture": {},
            "evaporate_in_downdraft_forced_downmoisture": {},
            "local_geopotential_height_cloud_levels_forced_downmoisture": {},
            "mass_entrainment_downdraft_forced_downmoisture": {},
            "mass_detrainment_downdraft_forced_downmoisture": {},
            "local_gamma_cloud_levels_forced_downmoisture": {},
            "total_normalized_integrated_condensate_forced_downmoisture": {},
            "total_normalized_integrated_evaporate_forced_downmoisture": {},
            "local_buoyancy_downmoisture": {},
        }
    ...
    def __call__(self, constants: dict, cu_param_constants: dict, plume: str, **inputs):
        ...
        locals.vapor_cloud_levels_forced.data[:] = inputs["local_vapor_cloud_levels_forced_downmoisture"]
        ...
        locals.vapor_wetbulb.data[:] = inputs["local_vapor_wetbulb_downmoisture"]
        state.output.normalized_massflux_downdraft_forced.data[
            :, :, :, plume_dependent_constants.PLUME_INDEX
        ] = inputs["normalized_massflux_downdraft_forced_downmoisture"]
        ...
        state.output.evaporate_in_downdraft_forced.data[:, :, :, plume_dependent_constants.PLUME_INDEX] = (
            inputs["evaporate_in_downdraft_forced_downmoisture"]
        )
        ...
        state.output.mass_entrainment_downdraft_forced.data[
            :, :, :, plume_dependent_constants.PLUME_INDEX
        ] = inputs["mass_entrainment_downdraft_forced_downmoisture"]
        state.output.mass_detrainment_downdraft_forced.data[
            :, :, :, plume_dependent_constants.PLUME_INDEX
        ] = inputs["mass_detrainment_downdraft_forced_downmoisture"]
        locals.gamma_cloud_levels_forced.data[:] = inputs["local_gamma_cloud_levels_forced_downmoisture"]
        ...
        locals.buoyancy.data[:] = inputs["local_buoyancy_downmoisture"]
        ...
        outputs = {
            ...
            "local_vapor_cloud_levels_forced_downmoisture": locals.vapor_cloud_levels_forced.data[:],
            "local_env_saturation_mixing_ratio_cloud_levels_forced_downmoisture": locals.environment_saturation_mixing_ratio_cloud_levels_forced.data[
                :
            ],
            "local_cloud_total_water_after_entrainment_forced_downmoisture": locals.cloud_total_water_after_entrainment_forced.data[
                :
            ],
            ...
            "local_downdraft_saturation_vapor_forced_downmoisture": locals.downdraft_saturation_vapor_forced.data[
                :
            ],
            "local_vapor_wetbulb_downmoisture": locals.vapor_wetbulb.data[:],
            "normalized_massflux_downdraft_forced_downmoisture": state.output.normalized_massflux_downdraft_forced.data[
                :, :, :, plume_dependent_constants.PLUME_INDEX
            ],
            "local_env_moist_static_energy_forced_downmoisture": locals.environment_moist_static_energy_forced.data[
                :
            ],
            "local_env_saturation_moist_static_energy_cloud_levels_forced_downmoisture": locals.environment_saturation_moist_static_energy_cloud_levels_forced.data[
                :
            ],
            "local_cloud_moist_static_energy_downdraft_forced_downmoisture": locals.cloud_moist_static_energy_downdraft_forced.data[
                :
            ],
            "evaporate_in_downdraft_forced_downmoisture": state.output.evaporate_in_downdraft_forced.data[
                :, :, :, plume_dependent_constants.PLUME_INDEX
            ],
            "local_geopotential_height_cloud_levels_forced_downmoisture": locals.geopotential_height_cloud_levels_forced.data[
                :
            ],
            "mass_entrainment_downdraft_forced_downmoisture": state.output.mass_entrainment_downdraft_forced.data[
                :, :, :, plume_dependent_constants.PLUME_INDEX
            ],
            "mass_detrainment_downdraft_forced_downmoisture": state.output.mass_detrainment_downdraft_forced.data[
                :, :, :, plume_dependent_constants.PLUME_INDEX
            ],
            "local_gamma_cloud_levels_forced_downmoisture": locals.gamma_cloud_levels_forced.data[:],
            "total_normalized_integrated_condensate_forced_downmoisture": state.output.total_normalized_integrated_condensate_forced.data[
                :, :, plume_dependent_constants.PLUME_INDEX
            ],
            "total_normalized_integrated_evaporate_forced_downmoisture": state.output.total_normalized_integrated_evaporate_forced.data[
                :, :, plume_dependent_constants.PLUME_INDEX
            ],
            "local_buoyancy_downmoisture": locals.buoyancy.data[:],
        }
