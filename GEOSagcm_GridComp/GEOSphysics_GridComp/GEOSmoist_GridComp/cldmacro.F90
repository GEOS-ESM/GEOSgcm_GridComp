...
!+---+-----------------------------------------------------------------+ 
      ...
      lambda = 3.0 / deice
      make_IceNumber = Q_ice * lambda*lambda*lambda / (PI*Ice_density*CLDPARAMS%DISP_FACTOR_ICE)
!+---+-----------------------------------------------------------------+ 
...
!+---+
      ...
      make_DropletNumber = SNGL(qnc)/CLDPARAMS%DISP_FACTOR_LIQ !DONIF needs to be tuned. 
