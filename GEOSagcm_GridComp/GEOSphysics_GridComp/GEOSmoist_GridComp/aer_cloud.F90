...
!Global aux variables
      ...
      real*8  ::  base_mass_so4_polluted, base_mass_so4_clean, base_mass_ss, &
                    ...
                    INSSfactor
      real :: conv_num_scale_liq, conv_num_scale_ice              
...
!
      ...
      subroutine aer_cloud_init(conv_liq_sc, conv_ice_sc)
  
        real*8 :: daux, sigaux, ahet_bc
        integer ::ix
        real :: conv_liq_sc, conv_ice_sc
    ...
    conv_num_scale_liq =  conv_liq_sc
    conv_num_scale_ice  =  conv_ice_sc
...
!+---+-----------------------------------------------------------------+ 
      ...
      lambda = 3.0 / deice
      make_IceNumber = conv_num_scale_ice*Q_ice * lambda*lambda*lambda / (PI*Ice_density)
...
!+---+
      ...
      make_DropletNumber = SNGL(qnc)*conv_num_scale_liq
