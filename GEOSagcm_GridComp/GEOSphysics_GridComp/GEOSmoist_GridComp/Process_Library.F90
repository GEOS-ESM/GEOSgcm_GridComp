...
USE utils_ppser_kbuff
 ...
 ! parameters
  ...
  public :: pdf_alpha
#ifdef SERIALIZE
public :: serialize_process_libraries_constants
#endif
...
SELECT CASE ( ppser_get_mode() )
  CASE(0)
    ...
    call fs_write_field(ppser_serializer, ppser_savepoint, 'aT_ICE_MAX', aT_ICE_MAX)
    call fs_write_field(ppser_serializer, ppser_savepoint, 'aICEFRPWR', aICEFRPWR)
    call fs_write_field(ppser_serializer, ppser_savepoint, 'iT_ICE_ALL', iT_ICE_ALL)
    call fs_write_field(ppser_serializer, ppser_savepoint, 'iT_ICE_MAX', iT_ICE_MAX)
    call fs_write_field(ppser_serializer, ppser_savepoint, 'iICEFRPWR', iICEFRPWR)
    call fs_write_field(ppser_serializer, ppser_savepoint, 'lT_ICE_ALL', lT_ICE_ALL)
    call fs_write_field(ppser_serializer, ppser_savepoint, 'lT_ICE_MAX', lT_ICE_MAX)
    call fs_write_field(ppser_serializer, ppser_savepoint, 'lICEFRPWR', lICEFRPWR)
    call fs_write_field(ppser_serializer, ppser_savepoint, 'oT_ICE_ALL', oT_ICE_ALL)
    call fs_write_field(ppser_serializer, ppser_savepoint, 'oT_ICE_MAX', oT_ICE_MAX)
    call fs_write_field(ppser_serializer, ppser_savepoint, 'oICEFRPWR', oICEFRPWR)
    call fs_write_field(ppser_serializer, ppser_savepoint, 'JaT_ICE_ALL', JaT_ICE_ALL)
    call fs_write_field(ppser_serializer, ppser_savepoint, 'JaT_ICE_MAX', JaT_ICE_MAX)
    call fs_write_field(ppser_serializer, ppser_savepoint, 'JaICEFRPWR', JaICEFRPWR)
    call fs_write_field(ppser_serializer, ppser_savepoint, 'JiT_ICE_ALL', JiT_ICE_ALL)
    call fs_write_field(ppser_serializer, ppser_savepoint, 'JiT_ICE_MAX', JiT_ICE_MAX)
    call fs_write_field(ppser_serializer, ppser_savepoint, 'JiICEFRPWR', JiICEFRPWR)
    call fs_write_field(ppser_serializer, ppser_savepoint, 'EPSILON', EPSILON)
    call fs_write_field(ppser_serializer, ppser_savepoint, 'K_COND', K_COND)
    call fs_write_field(ppser_serializer, ppser_savepoint, 'DIFFU', DIFFU)
    call fs_write_field(ppser_serializer, ppser_savepoint, 'TAUFRZ', taufrz)
    call fs_write_field(ppser_serializer, ppser_savepoint, 'dQCMAX', dQCmax)
    call fs_write_field(ppser_serializer, ppser_savepoint, 'ABETA', abeta)
    call fs_write_field(ppser_serializer, ppser_savepoint, 'R13BBETA', r13bbeta)
    call fs_write_field(ppser_serializer, ppser_savepoint, 'BX', bx)
    call fs_write_field(ppser_serializer, ppser_savepoint, 'RHO_W', RHO_W)
    call fs_write_field(ppser_serializer, ppser_savepoint, 'LDISS', Ldiss)
    call fs_write_field(ppser_serializer, ppser_savepoint, 'LK', Lk)
    call fs_write_field(ppser_serializer, ppser_savepoint, 'LBE', Lbe)
    call fs_write_field(ppser_serializer, ppser_savepoint, 'LBX', Lbx)
    call fs_write_field(ppser_serializer, ppser_savepoint, 'RHO_I', RHO_I)
    call fs_write_field(ppser_serializer, ppser_savepoint, 'CPBGRAV', cpbgrav)
    call fs_write_field(ppser_serializer, ppser_savepoint, 'GRAVBCP', gravbcp)
    call fs_write_field(ppser_serializer, ppser_savepoint, 'ALHLBCP', alhlbcp)
...
SELECT CASE ( ppser_get_mode() )
  CASE(0)
    ...
    call fs_write_field(ppser_serializer, ppser_savepoint, 'ICE_RADII_PARAM', ICE_RADII_PARAM)
    call fs_write_field(ppser_serializer, ppser_savepoint, 'R_AIR', R_AIR)
END SELECT
end subroutine serialize_process_libraries_constants
#endif
