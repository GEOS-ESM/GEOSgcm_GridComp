module test_cloud_microphys_subroutines
    ...
    subroutine test_gfdl_cloud_microphys_driver(IM, JM, LM, dirName, rank_str)
        ...
        print*, '#CI#VAR|DQVDTmic#REF|',sum(DQVDTmic_ref)
        print*, '#CI#VAR|DQVDTmic#THRSH|',sum(DQVDTmic_ref)*1.0e-9

        print*, '#CI#VAR|DQLDTmic#DIFF|',sum(DQLDTmic_ref - DQLDTmic)
        print*, '#CI#VAR|DQLDTmic#NEW|',sum(DQLDTmic)
        print*, '#CI#VAR|DQLDTmic#REF|',sum(DQLDTmic_ref)
        print*, '#CI#VAR|DQLDTmic#THRSH|',sum(DQLDTmic_ref)*1.0e-9

        print*, '#CI#VAR|DQRDTmic#DIFF|',sum(DQRDTmic_ref - DQRDTmic)
        print*, '#CI#VAR|DQRDTmic#NEW|',sum(DQRDTmic)
        print*, '#CI#VAR|DQRDTmic#REF|',sum(DQRDTmic_ref)
        print*, '#CI#VAR|DQRDTmic#THRSH|',sum(DQRDTmic_ref)*1.0e-9

        print*, '#CI#VAR|DQIDTmic#DIFF|',sum(DQIDTmic_ref - DQIDTmic)
        print*, '#CI#VAR|DQIDTmic#NEW|',sum(DQIDTmic)
        print*, '#CI#VAR|DQIDTmic#REF|',sum(DQIDTmic_ref)
        print*, '#CI#VAR|DQIDTmic#THRSH|',sum(DQIDTmic_ref)*1.0e-9

        print*, '#CI#VAR|DQSDTmic#DIFF|',sum(DQSDTmic_ref - DQSDTmic)
        ...
        print*, '#CI#VAR|PRCP_RAIN#REF|',sum(PRCP_RAIN_ref)
        print*, '#CI#VAR|PRCP_RAIN#THRSH|',sum(PRCP_RAIN_ref)*1.0e-9

        print*, '#CI#VAR|PRCP_SNOW#DIFF|',sum(PRCP_SNOW_ref - PRCP_SNOW)
        print*, '#CI#VAR|PRCP_SNOW#NEW|',sum(PRCP_SNOW)
        print*, '#CI#VAR|PRCP_SNOW#REF|',sum(PRCP_SNOW_ref)
        print*, '#CI#VAR|PRCP_SNOW#THRSH|',sum(PRCP_SNOW_ref)*1.0e-9

        print*, '#CI#VAR|PRCP_ICE#DIFF|',sum(PRCP_ICE_ref - PRCP_ICE)
        print*, '#CI#VAR|PRCP_ICE#NEW|',sum(PRCP_ICE)
        print*, '#CI#VAR|PRCP_ICE#REF|',sum(PRCP_ICE_ref)
        print*, '#CI#VAR|PRCP_ICE#THRSH|',sum(PRCP_ICE_ref)*1.0e-9

        print*, '#CI#VAR|PRCP_GRAUPEL#DIFF|',sum(PRCP_GRAUPEL_ref - PRCP_GRAUPEL)
        print*, '#CI#VAR|PRCP_GRAUPEL#NEW|',sum(PRCP_GRAUPEL)
        print*, '#CI#VAR|PRCP_GRAUPEL#REF|',sum(PRCP_GRAUPEL_ref)
        print*, '#CI#VAR|PRCP_GRAUPEL#THRSH|',sum(PRCP_GRAUPEL_ref)*1.0e-9

        print*, '#CI#VAR|PFL_LS#DIFF|',sum(PFL_LS_ref - PFL_LS)
        print*, '#CI#VAR|PFL_LS#NEW|',sum(PFL_LS)
        print*, '#CI#VAR|PFL_LS#REF|',sum(PFL_LS_ref)
        print*, '#CI#VAR|PFL_LS#THRSH|',sum(PFL_LS_ref)*1.0e-9

        print*, '#CI#VAR|PFI_LS#DIFF|',sum(PFI_LS_ref - PFI_LS)
