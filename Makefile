programName = RUN_SHOC_MINIAPP

FC = nvfortran
#OPT = -O3 -Mflushz -Mfunc32 -Kieee -Minfo #NVIDIA compiler options
OPT = -O3 -Mfunc32 -Kieee -acc=gpu -gpu=flushz -Minfo=acc -Kieee#NVIDIA compiler options
...
OBJ = MAPL_Constants.o MAPL_SatVapor.o shocparams.o shoc.o standalone.o
