...
#OPT = -O3 -Mfunc32 -Kieee -mp=gpu -gpu=flushz -Minfo=mp #NVIDIA compiler options
OPT = -g -O3 -fPIC -ffree-line-length-0 -fopenmp -foffload="-lgfortran -lgomp -lm -msoft-stack" -foffload=nvptx-none # Gfortran compiler options
